...
class TransactionControllerTest {
    ...
    void successUseBalance() throws Exception {
        ...
        //when
        //then
        mockMvc.perform(post("/transaction/use") // /하나 없어도 실패하는 세상.
    ...
    void successCancelBalance() throws Exception {
        ...
        //when
        //then
        mockMvc.perform(post("/transaction/cancel") // /하나 없어도 실패하는 세상.
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(objectMapper.writeValueAsString(
    ...
    void successQueryTransaction() throws Exception{
        ...
        mockMvc.perform(get("/transaction/12345"))
                ...
                .andExpect(jsonPath("$.transactionResultType").value("S"))//여기 강의 상에서는 통과하지만, 실제로는 통과를 못하는 중. //resultType으로 받아야 함
                .andExpect(jsonPath("$.transactionId").value("transactionIdForCancel"))
